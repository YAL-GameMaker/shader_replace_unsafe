...
(_dotresult = min(_dotresult, _dir.w));
...
{
{
(_atten = (1.0 / (_veclen / _posrange.w)));
...
(_ws_normal = mul(transpose(_gm_Matrices[2]), _objectspacenormal4).xyz);
